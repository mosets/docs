...
############################
# Mosets Tree version 3.10.9
DELETE FROM `#__mt_config` WHERE `varname` IN ('show_share_with_googleplus');
UPDATE `#__mt_config` SET `ordering` = '4110' WHERE `varname` = 'cluster_map_max_zoom';
UPDATE `#__mt_config` SET `ordering` = '4113' WHERE `varname` = 'google_maps_api_key';
UPDATE `#__mt_config` SET `configcode` = 'textarea' WHERE `varname` = 'google_maps_styled_map_style_array';
INSERT INTO `m0gk_mt_config` (`varname`, `groupname`, `value`, `default`, `configcode`, `ordering`, `displayed`, `overridable_by_category`) VALUES ('note_map_provider', 'map', '', '', 'note', '3948', '1', '1'), ('note_google_maps', 'map', '', '', 'note', '4111', '1', '1'), ('map_provider', 'map', 'google', '\custom', 'map_providers', '3949', '1', '1'), ('note_mapbox', 'map', '', '', 'note', 4130, 1, 1), ('mapbox_access_token', 'map', '', '', 'text', '4135', '1', '0'), ('note_here', 'map', '', '', 'note', '4140', '1', '1'), ('here_app_id', 'map', '', '', 'text', '4145', '1', '0'), ('here_app_code', 'map', '', '', 'text', '4150', '1', '0'), ('note_custom_tile_server', 'map', '', '', 'note', 4160, 1, 0), ('custom_tile_server', 'map', '{\"url\": \"https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png\", \"attribution\": \"&copy; <a href=\\\"https://www.openstreetmap.org/copyright\\\">OpenStreetMap</a> contributors &copy; <a href=\\\"https://carto.com/attributions\\\">CARTO</a>\"}', '{\"url\": \"https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png\", \"attribution\": \"&copy; <a href=\\\"https://www.openstreetmap.org/copyright\\\">OpenStreetMap</a> contributors &copy; <a href=\\\"https://carto.com/attributions\\\">CARTO</a>\"}', 'tile_servers', 4165, 1, 0), ('custom_tile_url', 'map', '', '', 'text', 4170, 1, 0), ('custom_tile_attribution', 'map', '', '', 'text', 4180, 1, 0);

############################
# Update Mosets Tree Version number
UPDATE  `#__mt_config` SET  `value` =  '3.10.9' WHERE  `#__mt_config`.`varname` =  'version';
...
UPDATE  `#__mt_config` SET  `value` =  '9' WHERE  `#__mt_config`.`varname` =  'dev_version';
```
